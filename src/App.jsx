...
export default function SBPDQuotes() {
  ...
  return (
    <div className="sbpd-container">
      <header>
        <img src="src/assets/android-chrome-192x192.png" alt="pinneaple-emoji" className="badge" />
      ...
      <div className="case-file">
        ...
        <p className="value quote-text">
          {quote ? `"${quote.quote}"` : "Tap the pinneaple!"}
        </p>
...
<p className="source">
  {quote ? <a href={quote.sourceUrl} target="_blank" rel="noopener noreferrer">Source</a> : ""}
</p>
